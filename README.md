# HappyHop - 강원도 관광 활성화를 위한 스마트워치 기반 오락형 관광 소프트웨어

> 한국관광공사 데이터랩 통계에 따르면, 강원도 방문율은 청년층에 비해 노인층이 높음을 볼 수 있습니다.
> 이를 개선하기 위해 젊은 층을 타겟으로 한 스마트워치 관광 소프트웨어 '해피홉(HappyHop)'을 제안합니다.
